...
当成一个残差问题来学习，对于一个初始的回归边界框(l',t',r', b')，首先提取star-shape的表示进行编码，然后学习4个距离缩放系数.![](http://latex.codecogs.com/png.latex?\dpi{110}&space;(\Delta&space;l,&space;\Delta&space;t,&space;\Delta&space;r,&space;\Delta&space;b)
